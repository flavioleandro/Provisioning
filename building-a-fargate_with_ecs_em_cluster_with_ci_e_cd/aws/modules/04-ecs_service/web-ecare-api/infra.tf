...
resource "aws_ecs_task_definition" "ecs_task_definition" {
  ...
  volume {
    ...
    #host_path = "/ecs/docker-jenkins/${var.project_name}"
  }
...
#   name         = "${var.env}-${var.project_name}-java"
...
resource "aws_codebuild_project" "codebuild" {
  ...
  source {
    type      = "S3"
    location  = "claro-artifact-store-${var.project_name}/${var.env}-${var.project_name}.zip"
  ...
  stage { 
    ...
    action {
      ...
      configuration = {
        ...
        S3ObjectKey            = "${var.env}-${var.project_name}.zip"
